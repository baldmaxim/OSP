...
описан в UI_GUIDELINES, на другие разделы автоматически не переносить. У «Тендеров на материалы» — плотный вариант `tp-dense-mat` (там же): ссылка-описание с подчёркиванием,
