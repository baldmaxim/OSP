...
// ВОРы и РД — документ со строками
export const IconVors = () => (
  <NavSvg>
...
// Заявки на проверку ДП/ДС — документ с галочкой проверки.
// Намеренно НЕ похожа на IconDcRequest (документ с карандашом): пункты меню
// стоят рядом, и одинаковые иконки путали бы разделы.
export const IconDocCheck = () => (
  <NavSvg>
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h5" />
    <path d="M14 2v4a2 2 0 0 0 2 2h4v3" />
    <path d="M8 12h4M8 16h3" />
    <circle cx="17.5" cy="17.5" r="4.5" />
    <path d="m15.6 17.6 1.4 1.4 2.6-2.7" />
  </NavSvg>
)
